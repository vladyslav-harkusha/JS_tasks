...
const calcSquareArea = (sideA, sideB) => sideA * sideB;
...
const calcCylinderArea = (radius, height) => 2 * Math.PI * radius * height;
console.log(calcCylinderArea(5, 3));


// #SIdMd0hQ
// - створити функцію яка приймає масив та виводить кожен його елемент
const logElement = (arr) => {
...
const createList1 = (text) => document.write(`
		<ul>
			<li>${text}</li>
			<li>${text}</li>
			<li>${text}</li>
...
const createList2 = (text, quantity) => {
	document.write('<ul>');
...
const printArray = (arrayOfObjects) => {
	document.write('<ul>');
...
const findMinNumber = (arrOfNumbers) => {
